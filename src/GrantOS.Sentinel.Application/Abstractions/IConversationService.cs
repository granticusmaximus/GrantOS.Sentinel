...
public interface IConversationService
{
    ...
    Task<ChatMessage> AddMessageAsync(int conversationId, ChatRole role, string content, int? tokenCount, string? toolName = null, string? toolArguments = null, CancellationToken ct = default);
